...
type BattleReport struct {
	...
	AttackName            string `json:"attack_name" gorm:"column:attack_name;index"`              // 进攻方名字
	AttackUnionName       string `json:"attack_union_name" gorm:"column:attack_union_name;index"`  // 进攻方同盟名字
	...
	DefendName            string `json:"defend_name" gorm:"column:defend_name;index"`              // 防守方名字
	DefendUnionName       string `json:"defend_union_name" gorm:"column:defend_union_name;index"`  // 防守方同盟名字
	...
	Npc                   int64  `json:"npc" gorm:"column:npc;index"`                              // 是否为与npc战斗
